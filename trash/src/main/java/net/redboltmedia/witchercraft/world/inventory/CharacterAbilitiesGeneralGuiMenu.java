...
public class CharacterAbilitiesGeneralGuiMenu extends AbstractContainerMenu implements WitchercraftModMenus.MenuAccessor {
	...
	public CharacterAbilitiesGeneralGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(WitchercraftModMenus.CHARACTER_ABILITIES_GENERAL_GUI.get(), id);
