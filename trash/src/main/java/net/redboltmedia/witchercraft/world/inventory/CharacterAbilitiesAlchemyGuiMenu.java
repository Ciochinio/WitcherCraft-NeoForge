...
public class CharacterAbilitiesAlchemyGuiMenu extends AbstractContainerMenu implements WitchercraftModMenus.MenuAccessor {
	...
	public CharacterAbilitiesAlchemyGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(WitchercraftModMenus.CHARACTER_ABILITIES_ALCHEMY_GUI.get(), id);
