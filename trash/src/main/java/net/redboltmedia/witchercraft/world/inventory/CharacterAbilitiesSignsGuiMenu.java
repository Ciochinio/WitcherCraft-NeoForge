...
public class CharacterAbilitiesSignsGuiMenu extends AbstractContainerMenu implements WitchercraftModMenus.MenuAccessor {
	...
	public CharacterAbilitiesSignsGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(WitchercraftModMenus.CHARACTER_ABILITIES_SIGNS_GUI.get(), id);
