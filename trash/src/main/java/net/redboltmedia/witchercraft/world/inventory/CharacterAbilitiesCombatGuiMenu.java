...
public class CharacterAbilitiesCombatGuiMenu extends AbstractContainerMenu implements WitchercraftModMenus.MenuAccessor {
	...
	public CharacterAbilitiesCombatGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(WitchercraftModMenus.CHARACTER_ABILITIES_COMBAT_GUI.get(), id);
