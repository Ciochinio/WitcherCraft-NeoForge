...
public record CharacterAbilitiesAlchemyGuiButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	public static final Type<CharacterAbilitiesAlchemyGuiButtonMessage> TYPE = new Type<>(Identifier.fromNamespaceAndPath(WitchercraftMod.MODID, "character_abilities_alchemy_gui_buttons"));
