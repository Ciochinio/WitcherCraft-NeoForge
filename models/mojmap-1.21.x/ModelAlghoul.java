public class ModelAlghoul extends EntityModel<LivingEntityRenderState> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		back_spikes.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(40, 67).addBox(-1.0F, -0.92931F, -1.48416F, 2.0F, 6.0F, 2.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(2.83042F, -1.93649F, 1.1639F, -0.50558F, 0.00288F, 0.11992F));
		back_spikes.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(24, 52).addBox(-1.0F, -4.53535F, -1.61605F, 2.0F, 5.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(2.83042F, -2.13649F, 1.1639F, -0.89828F, 0.00288F, 0.11992F));
		back_spikes.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(40, 67).mirror().addBox(-1.0F, -0.92931F, -1.48416F, 2.0F, 6.0F, 2.0F, new CubeDeformation(-0.2F)).mirror(false), PartPose.offsetAndRotation(-2.8619F, -1.93649F, 1.1639F, -0.50558F, -0.00288F, -0.11992F));
		back_spikes.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(24, 52).mirror().addBox(-1.0F, -4.53535F, -1.61605F, 2.0F, 5.0F, 2.0F, new CubeDeformation(-0.5F)).mirror(false), PartPose.offsetAndRotation(-2.8619F, -2.13649F, 1.1639F, -0.89828F, -0.00288F, -0.11992F));
		back_spikes.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(32, 67).addBox(-1.0F, -6.53535F, -1.61605F, 2.0F, 7.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.03042F, -2.63649F, 3.1639F, -0.95993F, 0.00206F, 0.0F));
		back_spikes.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(40, 67).addBox(-1.0F, -0.92931F, -1.48416F, 2.0F, 6.0F, 2.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.03042F, -2.63649F, 3.1639F, -0.74176F, 0.00206F, 0.0F));
		...
		spikes.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(24, 52).addBox(-1.0F, -2.5F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(2.99786F, -5.28294F, 0.33121F, -0.60282F, 0.05891F, 0.18314F));
		...
		spikes.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(24, 52).mirror().addBox(-1.0F, -2.5F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(-0.5F)).mirror(false), PartPose.offsetAndRotation(-2.99786F, -5.28294F, 0.33121F, -0.60282F, -0.05891F, -0.18314F));
		spikes.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(40, 67).mirror().addBox(-1.3F, -3.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(-0.2F)).mirror(false), PartPose.offsetAndRotation(-2.0F, -1.55667F, -1.99135F, -0.47192F, -0.05891F, -0.18314F));
		...
		spikes.addOrReplaceChild("cube_r21", CubeListBuilder.create().texOffs(68, 21).mirror().addBox(-1.0F, -3.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(-0.5F)).mirror(false), PartPose.offsetAndRotation(-3.26347F, -6.14867F, 6.2686F, -0.73372F, -0.05891F, -0.18314F));
		spikes.addOrReplaceChild("cube_r22", CubeListBuilder.create().texOffs(24, 67).mirror().addBox(-1.3F, -4.0F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(-0.2F)).mirror(false), PartPose.offsetAndRotation(-2.0F, -1.55667F, 2.60865F, -0.60282F, -0.05891F, -0.18314F));
		...
		spikes.addOrReplaceChild("cube_r24", CubeListBuilder.create().texOffs(24, 52).addBox(-1.0F, -2.5F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(2.99786F, -3.78294F, 9.03121F, -0.82099F, 0.05891F, 0.18314F));
		spikes.addOrReplaceChild("cube_r25", CubeListBuilder.create().texOffs(24, 52).mirror().addBox(-1.0F, -2.5F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(-0.5F)).mirror(false), PartPose.offsetAndRotation(-2.99786F, -3.78294F, 9.03121F, -0.82099F, -0.05891F, -0.18314F));
		spikes.addOrReplaceChild("cube_r26", CubeListBuilder.create().texOffs(40, 67).mirror().addBox(-1.3F, -3.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(-0.2F)).mirror(false), PartPose.offsetAndRotation(-2.0F, -0.55667F, 6.00865F, -0.60282F, -0.05891F, -0.18314F));
		spikes.addOrReplaceChild("cube_r27", CubeListBuilder.create().texOffs(38, 31).mirror().addBox(0.0F, -2.75F, 0.6F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.5F)).mirror(false), PartPose.offsetAndRotation(2.55331F, -0.91084F, -2.34103F, -0.74892F, 0.17957F, 0.39985F));
		spikes.addOrReplaceChild("cube_r28", CubeListBuilder.create().texOffs(68, 47).mirror().addBox(0.0F, -0.75F, 0.6F, 2.0F, 4.0F, 2.0F, new CubeDeformation(-0.4F)).mirror(false), PartPose.offsetAndRotation(2.55331F, -0.91084F, -2.34103F, -0.74892F, 0.17957F, 0.39985F));
		spikes.addOrReplaceChild("cube_r29", CubeListBuilder.create().texOffs(68, 47).mirror().addBox(-0.3F, -3.05F, 3.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(-0.4F)).mirror(false), PartPose.offsetAndRotation(2.55331F, -0.91084F, -2.34103F, -0.74892F, 0.17957F, 0.39985F));
		spikes.addOrReplaceChild("cube_r30", CubeListBuilder.create().texOffs(38, 31).mirror().addBox(-0.3F, -5.05F, 3.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.5F)).mirror(false), PartPose.offsetAndRotation(2.55331F, -0.91084F, -2.34103F, -0.74892F, 0.17957F, 0.39985F));
		spikes.addOrReplaceChild("cube_r31", CubeListBuilder.create().texOffs(68, 47).mirror().addBox(-0.3F, -3.05F, 3.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(-0.4F)).mirror(false), PartPose.offsetAndRotation(2.55331F, -0.51084F, 1.25897F, -0.74892F, 0.17957F, 0.39985F));
		spikes.addOrReplaceChild("cube_r32", CubeListBuilder.create().texOffs(38, 31).mirror().addBox(-0.3F, -5.05F, 3.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.5F)).mirror(false), PartPose.offsetAndRotation(2.55331F, -0.51084F, 1.25897F, -0.74892F, 0.17957F, 0.39985F));
		spikes.addOrReplaceChild("cube_r33", CubeListBuilder.create().texOffs(38, 31).addBox(-1.7F, -5.05F, 3.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(-2.55331F, -0.51084F, 1.25897F, -0.74892F, -0.17957F, -0.39985F));
		spikes.addOrReplaceChild("cube_r34", CubeListBuilder.create().texOffs(68, 47).addBox(-1.7F, -3.05F, 3.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(-2.55331F, -0.51084F, 1.25897F, -0.74892F, -0.17957F, -0.39985F));
		spikes.addOrReplaceChild("cube_r35", CubeListBuilder.create().texOffs(38, 31).addBox(-1.7F, -5.05F, 3.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(-2.55331F, -0.91084F, -2.34103F, -0.74892F, -0.17957F, -0.39985F));
		spikes.addOrReplaceChild("cube_r36", CubeListBuilder.create().texOffs(68, 47).addBox(-1.7F, -3.05F, 3.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(-2.55331F, -0.91084F, -2.34103F, -0.74892F, -0.17957F, -0.39985F));
		spikes.addOrReplaceChild("cube_r37", CubeListBuilder.create().texOffs(38, 31).addBox(-2.0F, -2.75F, 0.6F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(-2.55331F, -0.91084F, -2.34103F, -0.74892F, -0.17957F, -0.39985F));
		spikes.addOrReplaceChild("cube_r38", CubeListBuilder.create().texOffs(68, 47).addBox(-2.0F, -0.75F, 0.6F, 2.0F, 4.0F, 2.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(-2.55331F, -0.91084F, -2.34103F, -0.74892F, -0.17957F, -0.39985F));
		...
		head_spikes.addOrReplaceChild("cube_r44", CubeListBuilder.create().texOffs(38, 31).mirror().addBox(-1.0F, -3.2F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.5F)).mirror(false), PartPose.offsetAndRotation(2.0F, -0.20767F, -2.02454F, -0.43633F, 0.0F, 0.0F));
		head_spikes.addOrReplaceChild("cube_r45", CubeListBuilder.create().texOffs(38, 31).mirror().addBox(-0.4F, -1.6F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.5F)).mirror(false), PartPose.offsetAndRotation(2.0F, -2.29316F, 2.25807F, -0.42721F, 0.0916F, 0.19828F));
		head_spikes.addOrReplaceChild("cube_r46", CubeListBuilder.create().texOffs(68, 47).mirror().addBox(-0.4F, 0.4F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(-0.4F)).mirror(false), PartPose.offsetAndRotation(2.0F, -2.29316F, 2.25807F, -0.42721F, 0.0916F, 0.19828F));
		head_spikes.addOrReplaceChild("cube_r47", CubeListBuilder.create().texOffs(68, 47).addBox(-1.6F, 0.4F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(-2.0F, -2.29316F, 2.25807F, -0.42721F, -0.0916F, -0.19828F));
		head_spikes.addOrReplaceChild("cube_r48", CubeListBuilder.create().texOffs(38, 31).addBox(-1.6F, -1.6F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(-2.0F, -2.29316F, 2.25807F, -0.42721F, -0.0916F, -0.19828F));
		head_spikes.addOrReplaceChild("cube_r49", CubeListBuilder.create().texOffs(38, 31).mirror().addBox(-1.0F, -1.2F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.4F)).mirror(false), PartPose.offsetAndRotation(2.0F, -0.20767F, -2.02454F, -0.43633F, 0.0F, 0.0F));
