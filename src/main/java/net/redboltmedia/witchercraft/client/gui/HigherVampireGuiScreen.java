...
public class HigherVampireGuiScreen extends AbstractContainerScreen<HigherVampireGuiMenu> implements WitchercraftModScreens.ScreenAccessor {
	...
	protected void extractLabels(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
		guiGraphics.text(this.font, Component.translatable("gui.witchercraft.higher_vampire_gui.label_drowner"), 17, -11, -12829636, false);
		guiGraphics.text(this.font, Component.translatable("gui.witchercraft.higher_vampire_gui.label_type_hostal"), 17, 7, -12829636, false);
		guiGraphics.text(this.font, Component.translatable("gui.witchercraft.higher_vampire_gui.label_health_20"), 17, 34, -12829636, false);
		guiGraphics.text(this.font, Component.translatable("gui.witchercraft.higher_vampire_gui.label_atack_damage_5"), 17, 61, -12829636, false);
	}
