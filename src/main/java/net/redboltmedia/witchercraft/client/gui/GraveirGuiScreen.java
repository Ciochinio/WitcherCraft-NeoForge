...
public class GraveirGuiScreen extends AbstractContainerScreen<GraveirGuiMenu> implements WitchercraftModScreens.ScreenAccessor {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.witchercraft.graveir_gui.label_drowner"), 17, -11, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.witchercraft.graveir_gui.label_type_hostal"), 17, 7, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.witchercraft.graveir_gui.label_health_20"), 17, 34, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.witchercraft.graveir_gui.label_atack_damage_5"), 17, 61, -12829636, false);
	}
