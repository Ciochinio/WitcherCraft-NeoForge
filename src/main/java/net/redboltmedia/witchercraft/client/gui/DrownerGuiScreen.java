...
public class DrownerGuiScreen extends AbstractContainerScreen<DrownerGuiMenu> implements WitchercraftModScreens.ScreenAccessor {
	...
	protected void extractLabels(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
		guiGraphics.text(this.font, Component.translatable("gui.witchercraft.drowner_gui.label_drowner"), 8, -2, -12829636, false);
		guiGraphics.text(this.font, Component.translatable("gui.witchercraft.drowner_gui.label_type_hostal"), 8, 16, -12829636, false);
		guiGraphics.text(this.font, Component.translatable("gui.witchercraft.drowner_gui.label_health_20"), 8, 25, -12829636, false);
		guiGraphics.text(this.font, Component.translatable("gui.witchercraft.drowner_gui.label_atack_damage_5"), 8, 34, -12829636, false);
		guiGraphics.text(this.font, Component.translatable("gui.witchercraft.drowner_gui.label_weak_to_igni"), 8, 43, -12829636, false);
		guiGraphics.text(this.font, Component.translatable("gui.witchercraft.drowner_gui.label_loot_monster_brain_monster_too"), 8, 52, -12829636, false);
		guiGraphics.text(this.font, Component.translatable("gui.witchercraft.drowner_gui.label_spawning_swamp"), 8, 61, -12829636, false);
	}
	...
	public void init() {
		...
		imagebutton_bookmark = new ImageButton(this.leftPos + 195, this.topPos + -12, 32, 32, new WidgetSprites(Identifier.parse("witchercraft:textures/screens/bookmark.png"), Identifier.parse("witchercraft:textures/screens/bookmark.png")), e -> {
			int x = DrownerGuiScreen.this.x;
			int y = DrownerGuiScreen.this.y;
			if (true) {
		...
		imagebutton_arrowback = new ImageButton(this.leftPos + -82, this.topPos + 169, 32, 32, new WidgetSprites(Identifier.parse("witchercraft:textures/screens/arrowback.png"), Identifier.parse("witchercraft:textures/screens/arrowback.png")), e -> {
		}) {
			@Override
			public void extractContents(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
				guiGraphics.blit(RenderPipelines.GUI_TEXTURED, sprites.get(isActive(), isHoveredOrFocused()), getX(), getY(), 0, 0, width, height, width, height);
