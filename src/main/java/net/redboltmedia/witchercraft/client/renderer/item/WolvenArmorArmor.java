...
public class WolvenArmorArmor {
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		event.registerItem(new IClientItemExtensions() {
			private final ResourceLocation armorTexture = ResourceLocation.parse("witchercraft:textures/models/armor/wolven._layer_1.png");
		...
		event.registerItem(new IClientItemExtensions() {
			private final ResourceLocation armorTexture = ResourceLocation.parse("witchercraft:textures/models/armor/wolven._layer_2.png");
