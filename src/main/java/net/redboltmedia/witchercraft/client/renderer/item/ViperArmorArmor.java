...
public class ViperArmorArmor {
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		event.registerItem(new IClientItemExtensions() {
			private final Identifier armorTexture = Identifier.parse("witchercraft:textures/models/armor/viperarmor._layer_1.png");
		...
		event.registerItem(new IClientItemExtensions() {
			private final Identifier armorTexture = Identifier.parse("witchercraft:textures/models/armor/viperarmor._layer_2.png");
