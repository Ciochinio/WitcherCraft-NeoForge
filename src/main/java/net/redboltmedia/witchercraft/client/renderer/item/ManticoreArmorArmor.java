...
public class ManticoreArmorArmor {
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		event.registerItem(new IClientItemExtensions() {
			private final ResourceLocation armorTexture = ResourceLocation.parse("witchercraft:textures/models/armor/mantikora._layer_1.png");
		...
		event.registerItem(new IClientItemExtensions() {
			private final ResourceLocation armorTexture = ResourceLocation.parse("witchercraft:textures/models/armor/mantikora._layer_2.png");
		...
		}, WitchercraftModItems.MANTICORE_ARMOR_BOOTS.get());
	}
}