...
public class GriffinArmorArmor {
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		event.registerItem(new IClientItemExtensions() {
			private final Identifier armorTexture = Identifier.parse("witchercraft:textures/models/armor/griffin.__layer_1.png");
		...
		event.registerItem(new IClientItemExtensions() {
			private final Identifier armorTexture = Identifier.parse("witchercraft:textures/models/armor/griffin.__layer_2.png");
