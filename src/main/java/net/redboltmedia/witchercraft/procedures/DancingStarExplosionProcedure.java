				...
				if (!(entityiterator instanceof Player)) {
					{
						...
						if (_ent.level() instanceof ServerLevel _serverLevel) {
							_ent.hurtServer(_serverLevel, new DamageSource(world.holderOrThrow(ResourceKey.create(Registries.DAMAGE_TYPE, Identifier.parse("witchercraft:bomb")))), 5);
						}
					}
					entity.igniteForSeconds(15);
					if (entity instanceof ServerPlayer _player)
						_player.sendSystemMessage(Component.literal("DancingStar"), false);
				}
			}
		}
	}
