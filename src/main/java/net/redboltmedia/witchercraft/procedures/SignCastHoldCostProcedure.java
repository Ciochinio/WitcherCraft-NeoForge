...
public class SignCastHoldCostProcedure {
	...
	private static String execute(@Nullable Event event, Entity entity) {
		...
		if (entity.getData(WitchercraftModVariables.PLAYER_VARIABLES).witchercraftSignKeyHoldTime > 20
			...
			if (entity instanceof LivingEntity _livEnt1 && _livEnt1.hasEffect(WitchercraftModMobEffects.QUEN_SIGN) && entity.getData(WitchercraftModVariables.PLAYER_VARIABLES).witchercraftAbilitiesExplodingShield) {
				SignCost = SignCost + 2;
			}
		}
		{
