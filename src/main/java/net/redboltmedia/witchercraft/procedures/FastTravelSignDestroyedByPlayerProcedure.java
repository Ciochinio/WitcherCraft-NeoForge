...
public class FastTravelSignDestroyedByPlayerProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (FastTravelSignRemoveProcedure.execute(world, x, y, z)) {
			if (FastTravelSignDropsItemProcedure.execute() && !(entity instanceof Player _plr && _plr.getAbilities().instabuild)) {
