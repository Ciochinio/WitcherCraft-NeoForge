...
public class CraftBombDancingStarProcedure {
	public static void execute(Entity entity) {
		...
		if ((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof WitchercraftModMenus.MenuAccessor _menu0 ? _menu0.getSlots().get(1).getItem() : ItemStack.EMPTY).getItem() == Blocks.AIR.asItem()
				...
				&& (entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof WitchercraftModMenus.MenuAccessor _menu12 ? _menu12.getSlots().get(0).getItem() : ItemStack.EMPTY).getItem() == WitchercraftModItems.SALTPETER.get()
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof WitchercraftModMenus.MenuAccessor _menu) {
				...
				ItemStack _setstack20 = new ItemStack(WitchercraftModItems.DANCING_STAR.get()).copy();
				_setstack20.setCount(3);
				_menu.getSlots().get(7).set(_setstack20);
