		...
		if (entity instanceof LivingEntity _livingEntityAD && _livingEntityAD.getAttributes().hasAttribute(WitchercraftModAttributes.ADDITIONAL_DAMAGE)) {
			...
			if (entity instanceof LivingEntity _entity) {
				AttributeModifier modifier = new AttributeModifier(Identifier.parse("witchercraft:oil_correct"),
						4 * (1 + (entity instanceof LivingEntity _livingEntityOD && _livingEntityOD.getAttributes().hasAttribute(WitchercraftModAttributes.OIL_DAMAGE)
								? _livingEntityOD.getAttribute(WitchercraftModAttributes.OIL_DAMAGE).getValue()
								: 0) * 0.01),
