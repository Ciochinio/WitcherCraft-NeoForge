	...
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(WitchercraftModMobEffects.SUCCUBUS_DECOCTION_EFFECT)
			...
			if (entity instanceof LivingEntity _entity && _entity.getAttribute(WitchercraftModAttributes.INCREASED_DAMAGE) != null) {
				...
				_entity.getAttribute(WitchercraftModAttributes.INCREASED_DAMAGE).addTransientModifier(new AttributeModifier(Identifier.parse("witchercraft:effect_succubus_stacks"),
