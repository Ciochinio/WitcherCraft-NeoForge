...
public class PerkModifiersProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		...
		if (!world.isClientSide()) {
			if (entity.getData(WitchercraftModVariables.PLAYER_VARIABLES).witchercraftPerksDeadlyPrecision == true) {
			...
			if (entity.getData(WitchercraftModVariables.PLAYER_VARIABLES).witchercraftPerksPreciseBlows == true) {
				if (entity instanceof LivingEntity _entity) {
			...
			if (entity.getData(WitchercraftModVariables.PLAYER_VARIABLES).witchercraftPerksCrushingBlows == true) {
				if (entity instanceof LivingEntity _entity) {
			...
			if (entity.getData(WitchercraftModVariables.PLAYER_VARIABLES).witchercraftPerksAnatomicalKnowledge == true && ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.CROSSBOW
			...
			if (entity.getData(WitchercraftModVariables.PLAYER_VARIABLES).witchercraftPerksCripplingShot == true && ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.CROSSBOW
					|| (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.BOW)) {
				if (entity instanceof LivingEntity _entity) {
			...
			if (entity.getData(WitchercraftModVariables.PLAYER_VARIABLES).witchercraftPerksStrengthTraining == true) {
				if (entity instanceof LivingEntity _entity) {
			...
			if (entity.getData(WitchercraftModVariables.PLAYER_VARIABLES).witchercraftPerksSunderArmor == true) {
				if (entity instanceof LivingEntity _entity) {
			...
			if (entity.getData(WitchercraftModVariables.PLAYER_VARIABLES).witchercraftPerksMuscleMemory == true) {
				if (entity instanceof LivingEntity _entity) {
			...
			if (entity.getData(WitchercraftModVariables.PLAYER_VARIABLES).witchercraftPerksColdBlood == true && entity.getData(WitchercraftModVariables.PLAYER_VARIABLES).witchercraftEnemyNearby == false) {
				if (entity instanceof LivingEntity _entity) {
			...
			if (entity.getData(WitchercraftModVariables.PLAYER_VARIABLES).witchercraftPerksFloodOfAnger == true && entity.getData(WitchercraftModVariables.PLAYER_VARIABLES).witchercraftEnemyNearby == true) {
				if (entity instanceof LivingEntity _entity) {
			...
			if (entity.getData(WitchercraftModVariables.PLAYER_VARIABLES).witchercraftPerksSunAndStars == true && world instanceof Level _lvl37 && _lvl37.isBrightOutside()) {
				if (entity instanceof LivingEntity _entity) {
			...
			if (entity.getData(WitchercraftModVariables.PLAYER_VARIABLES).witchercraftPerksSunAndStars == true && !(world instanceof Level _lvl40 && _lvl40.isBrightOutside())) {
				if (entity instanceof LivingEntity _entity) {
			...
			if (entity.getData(WitchercraftModVariables.PLAYER_VARIABLES).witchercraftPerksDefence == true) {
				if (entity instanceof LivingEntity _entity) {
			...
			if (entity.getData(WitchercraftModVariables.PLAYER_VARIABLES).witchercraftPerksFleetFooted == true) {
				if (entity instanceof LivingEntity _entity) {
