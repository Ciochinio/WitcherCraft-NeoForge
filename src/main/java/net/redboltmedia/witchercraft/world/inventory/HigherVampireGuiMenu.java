...
public class HigherVampireGuiMenu extends AbstractContainerMenu implements WitchercraftModMenus.MenuAccessor {
	...
	public HigherVampireGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(WitchercraftModMenus.HIGHER_VAMPIRE_GUI.get(), id);
