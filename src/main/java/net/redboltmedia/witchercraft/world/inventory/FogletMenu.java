...
public class FogletMenu extends AbstractContainerMenu implements WitchercraftModMenus.MenuAccessor {
	...
	public FogletMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(WitchercraftModMenus.FOGLET.get(), id);
