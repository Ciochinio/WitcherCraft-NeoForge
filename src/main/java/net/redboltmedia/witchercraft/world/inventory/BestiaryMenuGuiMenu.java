...
import net.redboltmedia.witchercraft.procedures.PauseMenuGuiBlindProcedure;
...
@EventBusSubscriber
public class BestiaryMenuGuiMenu extends AbstractContainerMenu implements WitchercraftModMenus.MenuAccessor {
	...
	public BestiaryMenuGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(WitchercraftModMenus.BESTIARY_MENU_GUI.get(), id);
	...
	public static void onContainerOpen(PlayerContainerEvent.Open event) {
		...
		if (event.getContainer() instanceof BestiaryMenuGuiMenu menu) {
