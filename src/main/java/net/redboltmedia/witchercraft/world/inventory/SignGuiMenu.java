...
public class SignGuiMenu extends AbstractContainerMenu implements WitchercraftModMenus.MenuAccessor {
	...
	public SignGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(WitchercraftModMenus.SIGN_GUI.get(), id);
