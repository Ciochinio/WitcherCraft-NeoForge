...
public class PerkEquipGuiMenu extends AbstractContainerMenu implements WitchercraftModMenus.MenuAccessor {
	...
	public PerkEquipGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(WitchercraftModMenus.PERK_EQUIP_GUI.get(), id);
	...
	// Real trigger for the equipped-perk recompute: fired once, server-side,
	// when the equip screen is closed. Replaces the DebugRecomputePerksKeybind.
	@Override
	public void removed(Player player) {
		super.removed(player);
		if (player != null && !player.level().isClientSide()) {
			RecomputeEquippedPerksProcedure.execute(player);
		}
	}
