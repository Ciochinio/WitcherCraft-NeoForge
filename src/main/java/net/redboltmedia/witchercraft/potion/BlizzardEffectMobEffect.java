...
public class BlizzardEffectMobEffect extends MobEffect {
	public BlizzardEffectMobEffect() {
		...
		this.addAttributeModifier(WitchercraftModAttributes.DODGE_CHANCE, Identifier.fromNamespaceAndPath(WitchercraftMod.MODID, "effect.blizzard_effect_0"), 5, AttributeModifier.Operation.ADD_VALUE);
